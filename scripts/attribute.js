...
for (let i = 0; i < prevMetadata.length; i++) {
    ...
    const json = {
        description: `This is #${metadata.codeNoHash} of the ‘Gorilla in a Pink Mask’ NFT, which has been produced in a fractionalised edition of 10,000 by Exposed Walls. 
